    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        System.out.println("equation:   \n" +
                " 3.4x + 50.2y = 44.5\n" +
                " 2.1x + .55y = 5.9");
        System.out.println("x = (e * d - b * f) / (a * d - b * c) = " + ((44.5 * 0.55) - (50.2 * 5.9)) / ((3.4 * 0.55) - (50.2 * 2.1)));
        System.out.println("y = (a * f - e * c) / (a * d - b * c) = " + ((3.4 * 5.9) - (44.5 * 2.1)) / ((3.4 * 0.55) - (50.2 * 2.1)));
